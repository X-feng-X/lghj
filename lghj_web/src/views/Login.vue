    ...
    <div class="login-container">
        <div class="login-content">
            <div class="brand-section">
                ...
                <p class="brand-slogan">智能风控系统 · 投资顾问专家</p>
            ...
            <div class="login-form-card">
                <h2 class="form-title">{{ isRegister ? '注册 量股化金' : '登录 量股化金' }}</h2>
                <div class="title-line"></div>

                <el-form :model="loginForm" class="login-form" @submit.prevent="handleSubmit">
                    ...
                    <el-form-item label="密码" prop="password">
                        ...
                        <div class="forgot-password" v-if="!isRegister">忘记密码?</div>
                    </el-form-item>

                    <template v-if="isRegister">
                        <el-form-item label="确认密码" prop="confirmPassword">
                            <el-input v-model="loginForm.confirmPassword" type="password" show-password placeholder="请再次输入密码" />
                        </el-form-item>
...
const handleRegister = async () => {
    ...
    try {
        await register({
            username: loginForm.username,
            password: loginForm.password,
            nickName: loginForm.nickName || undefined,
