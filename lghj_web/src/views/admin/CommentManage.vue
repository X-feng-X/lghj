    ...
    <div class="comment-manage">
        <el-card>
            <div class="filter-container">
                <el-input v-model="queryParams.blogId" placeholder="博客ID" style="width: 200px;" class="filter-item"
                    @keyup.enter="handleFilter" />
                <el-button type="primary" @click="handleFilter">搜索</el-button>
            </div>

            <el-table :data="list" v-loading="listLoading" border style="width: 100%; margin-top: 20px;">
                <el-table-column prop="id" label="评论ID" width="100" align="center" />
...
const getList = async () => {
    ...
    try {
        const res = await getCommentPage(queryParams)
