<template>
    <div class="main-layout">
        <el-header class="app-header">
            <div class="header-content">
                ...
                <el-menu :default-active="activeMenu" class="nav-menu" mode="horizontal" :ellipsis="false" router>
                    ...
                    <el-menu-item index="/prediction">投资顾问</el-menu-item>
                    ...
                    <el-dropdown trigger="click" @command="handleCommand">
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item command="admin" v-if="userStore.userInfo.userType === 3">进入管理后台</el-dropdown-item>
        ...
        <el-footer class="app-footer">
            <p>Copyright © 2026 量股化金 - 智能投资顾问系统</p>
        </el-footer>
    </div>
</template>
