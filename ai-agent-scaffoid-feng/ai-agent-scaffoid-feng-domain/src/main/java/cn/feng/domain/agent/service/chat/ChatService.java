...
public class ChatService implements IChatService {
    ...
    public List<String> handleMessage(String agentId, String userId, String sessionId, String message) {
        ...
        Content userMsg = Content.fromParts(Part.fromText(buildUserContextMessage(userId, message)));
    ...
    public List<String> handleMessage(ChatCommandEntity chatCommandEntity) {
        ...
        parts.add(Part.fromText("系统上下文：当前用户ID为 " + chatCommandEntity.getUserId() + "。如需查询用户个性化交易画像，只能使用该用户ID。"));
    ...
    private String buildUserContextMessage(String userId, String message) {
        return "系统上下文：当前用户ID为 " + userId + "。如需查询用户个性化交易画像，只能使用该用户ID。\n用户问题：" + message;
    }
